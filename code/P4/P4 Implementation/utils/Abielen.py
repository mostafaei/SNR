...
class GeneratedTopo( Topo ):
    ...
    def __init__( self, **opts ):
        ...
        self.addLink( NewYork , Chicago, bw=2, delay='0.8063749756519597ms')
        self.addLink( NewYork , WashingtonDC, bw=2, delay='0.6058261920922032ms')
        self.addLink( Chicago , Indianapolis, bw=2, delay='1.34462717202682ms')
        self.addLink( WashingtonDC , Atlanta, bw=2, delay='0.5576369363217571ms')
        self.addLink( Seattle , Sunnyvale, bw=2, delay='1.2883712373801324ms')
        self.addLink( Seattle , Denver, bw=2, delay='1.1116934686536741ms')
        self.addLink( Sunnyvale , LosAngeles, bw=2, delay='0.5908136287074389ms')
        self.addLink( Sunnyvale , Denver, bw=2, delay='0.9973276822806197ms')
        self.addLink( LosAngeles , Houston, bw=2, delay='1.2016083326320164ms')
        self.addLink( Denver , KansasCity, bw=2, delay='0.22332879040333467ms')
        self.addLink( KansasCity , Houston, bw=2, delay='1.7132509272584917ms')
        self.addLink( KansasCity , Indianapolis, bw=2, delay='0.24089995947673676ms')
        self.addLink( Houston , Atlanta, bw=2, delay='1.3434450025626097ms')
        self.addLink( Atlanta , Indianapolis, bw=2, delay='0.5449626349765576ms')
